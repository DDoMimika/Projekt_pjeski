...
PATH_IMAGES = pathlib.Path("./baza_danych/images/Images")
PATH_ANNOTATIONS = pathlib.Path("./baza_danych/annotations/Annotation")
...
READY_DATABASE_FILENAME = "ready_data_base.json"
